...
xlim([-0.3 1.5])
ylim([-0.3 1])
h=patch([xmin, xmin, xmax, xmax], [xmin, xmax, xmax, xmin], [0.7 0.7 0.7], 'FaceAlpha', 0.5,'EdgeColor','none');
...
for i = 1:steps
    ...
    % MPC Control
    [U, xMPC] = solveMPC(A, B, Q, R, N, x, umin, umax,xmin,xmax);
...
grid on;
ylim([-0.5 1])
h=patch([0, steps*Ts, steps*Ts, 0], [xmin, xmin,xmax,xmax], [0.7 0.7 0.7], 'FaceAlpha', 0.5,'EdgeColor','none');
